...
public class AbilityWard : BaseAbility
{
    [Header("Warp")]
    [SerializeField] protected Spawner spawner;
    [SerializeField] protected bool isWarping = false;
    [SerializeField] protected float warpSpeed = 2f;
    ...
    protected virtual void MoveObj()
    {
        ...
        Transform fx = FXSpawner.Instance.Spawn(FXSpawner.impact_one, obj.position, fxRot);
